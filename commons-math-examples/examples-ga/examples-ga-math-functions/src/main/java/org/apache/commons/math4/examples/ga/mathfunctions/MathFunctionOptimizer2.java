    ...
    public void optimize(int dim,
        ...
        final Callable<Population<Chromosome, Coordinates>> ga =
            GeneticAlgorithmFactory.<Chromosome, Coordinates>create(numGenes,
                                                                    ...
                                                                    elitism,
                                                                    RandomSource.KISS,
                                                                    new GraphicalGenerationLogger(graphPlotter, graphName));
 ...
 * Log evolution.
 */
class GraphicalGenerationLogger implements GenerationCallback<Chromosome> {
    /** Logger. */
    ...
    GraphicalGenerationLogger(GraphPlotter graphPlotter, String graphName) {
    ...
    public void update(List<Map.Entry<Chromosome, Double>> contents,
        ...
        graphPlotter.addDataPoint(graphName, generation, Math.abs(stats.getMax()));
